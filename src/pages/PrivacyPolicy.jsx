    ...
    <section className="bg-gray-50 min-h-screen py-16">
      <div className="max-w-5xl mx-auto px-6 space-y-8">
        ...
        <p className="text-gray-700 leading-relaxed">
          When you visit or buy something from <strong>AadyaPay</strong>, this Privacy Policy applies
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700">
              ...
              access AadyaPay, including your browser, IP address, time zone, and cookies.
          ...
          <div>
            ...
            <p className="text-gray-700">
              ...
              Contact us at <strong>Support@aadyapay.in</strong> for questions.
            </p>
          </div>
        </div>
      </div>
