  ...
  return (
    <div className="flex max-w-7xl mx-auto p-6 sm:p-10 bg-white text-gray-800">
      ...
      <main className="flex-1 space-y-6">
        ...
        <p>
          Welcome to <strong>AadyaPay</strong>. Your use of AadyaPay on our Website or Mobile App 
          ...
          of at least 18 years of age. AadyaPay reserves the right, at its sole discretion,
        ...
        <p>
          ...
          under which you’re allowed to use the website and how we’ll treat your account and AadyaPay while
          you are a member.
        </p>
        ...
        <p>
          ...
          <a
            href="mailto:support@aadyapay.in"
        ...
        <section id="acceptance">
          ...
          <ul className="list-disc list-outside mt-4 mb-6 pl-5">
            <li>
                ...
                that AadyaPay will treat your use of the Services as acceptance of the Terms from that point onwards.
            </li>
            <li>
                For being a valid User, you must satisfy the following condition: You are of legal age to form 
                a binding contract with AadyaPay, or you are not a person barred from receiving the Services under
        ...
        <section id="eligibility">
          ...
          <p>
            ...
            or removed from the services by AadyaPay. By accepting these Terms & Conditions or by otherwise 
            ...
            account or your use of AadyaPay if any information provided by you is false, fictitious, 
        ...
        <section id="recharges">
          <p className="text-lg font-bold text-gray-700 mt-8 mb-4">
            4. AadyaPay Recharges
          </p>
          <p>
            We are a Reseller Only. AadyaPay does not provide mobile service and is only a reseller 
            of prepaid mobile services by telecommunications service providers or the providers of 
            such prepaid recharge. AadyaPay is not a warrantor, insurer, or guarantor of the services to be 
        ...
        <section id="general">
          ...
          <ul className="list-disc list-inside mb-6">
            ...
            <li>
              AadyaPay is not liable for payment delays due to reasons beyond our control.
            </li>
          </ul>
        </section>
        ...
        <section id="confidentiality">
          ...
          <p>Privacy of communication is subject to the terms of the certificate of authorization 
            ...
            in order to facilitate the provision of AadyaPay Wallet, AadyaPay may be required to 
        ...
        <section id="ip">
          ...
          <p>As between you and AadyaPay, all Materials, trademarks, service marks, and trade names contained 
            on the Site are the property of AadyaPay and/or third-party licensors or suppliers. You shall not 
            ...
            competing product. AadyaPay is owned by Zapnity Services OPC Private Limited. Unauthorized use is 
            strictly prohibited. All rights are expressly reserved to AadyaPay.
          </p>
        </section>

        <section id="disclaimer">
          <h2 className="text-lg font-bold text-gray-700 mt-8 mb-4">8. Disclaimer (No Warranty)</h2>
          <p>AadyaPay makes no warranty, express or implied, with respect to the Site and Related Applications 
            and Services offered. AadyaPay expressly disclaims the implied warranties of non-infringement, 
            merchantability, and fitness for any particular purpose. AadyaPay provides the Site and Related 
            ...
            and you should not rely on any such statement. In no event will AadyaPay be liable for any incidental, 
        ...
        <section id="indemnity">
          ...
          <p>You agree to indemnify, defend, and hold AadyaPay and/or related parties harmless from any 
            and all claims, losses, damages, and liabilities, costs, and expenses, including and without 
            limitation legal fees and expenses, arising out of or related to your use or misuse of AadyaPay, 
        ...
        <section id="liability">
          ...
          <p>Not withstanding anything to the contrary contained herein, neither AadyaPay, nor its affiliated 
        ...
        <section id="authorization">
          ...
          <p>
            AadyaPay reserves the right to change, modify, add, or remove portions of this Agreement 
            ...
            Your authorization will remain in full force and effect until your AadyaPay account is closed or terminated.
          </p>
        </section>
        ...
        <section id="refund">
          ...
          <p>All sales are final with no refund or exchange permitted. You are responsible for the information 
            you provide for the purchase and all charges that result from those purchases. AadyaPay is not responsible 
            for any purchase of incorrect information provided. If in a transaction performed by you on the Site, 
            money has been charged to your AadyaPay wallet, credit/debit card, or bank account, and recharge is not 
            delivered within two hours of your completion of the transaction, then you may inform us by sending 
            an email to our customer services email address as mentioned. AadyaPay shall investigate the incident, 
            and if it is found that money was charged to your AadyaPay wallet, credit/debit card, or bank account 
            without delivery of the recharge, then you will be refunded the money within 7 working days from the 
            date of receipt of your email. All refunds will be credited to your AadyaPay account.
          </p>
        </section>
        ...
        <section id="communication">
          ...
          <p>
            Customer also agrees to receive information regarding what AadyaPay perceives to be of their interest 
